...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _loadModel() async {
    ...
    print(totalInputSize.toString() + " " + totalOutputSize.toString());
    ...
    print("Hello darkness my old friend" + output.toString());
    setState(() {
      _modelinfo = interpreter.getInputTensor(0).numDimensions().toString();
    });
  }
